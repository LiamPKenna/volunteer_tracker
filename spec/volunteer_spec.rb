...
describe Volunteer do
  describe '#name' do
    it 'returns the name of the volunteer' do
      test_volunteer = Volunteer.new({:name => 'Jane', :project_id => 1, :id => nil, :hours => 0})
  ...
  describe '#==' do
    it 'checks for equality based on the name of a volunteer' do
      ...
      volunteer2 = Volunteer.new({:name => 'Jane', :project_id => 1, :id => nil, :hours => 0})
  ...
  context '.all' do
    ...
    it 'returns all volunteers' do
      volunteer1 = Volunteer.new({:name => 'Jane', :project_id => 1, :id => nil, :hours => 0})
      volunteer1.save
      volunteer2 = Volunteer.new({:name => 'Joe', :project_id => 1, :id => nil, :hours => 0})
      volunteer2.save
